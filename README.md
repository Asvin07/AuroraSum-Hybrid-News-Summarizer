...
- `AuroraSum_(2) (1).ipynb`: Full research pipeline with modular code blocks for data prep, hybrid summarizer logic, evaluation, optimization, and deployment code templates.
- `Aurora_Sum_Basic_UI-2.ipynb`: Lightweight notebook with a simple Gradio user interface for fast summarization tests.
